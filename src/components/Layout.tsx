...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="h-screen flex overflow-hidden bg-rose-50/30">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-rose-100 shrink-0 h-screen sticky top-0">
        <div className="p-5 border-b border-rose-100">
          <div className="flex items-center gap-2">
            <img
              src="/images/SheeshWay_Logo_edited.png"
              alt="SheeshWay"
      ...
      {/* Mobile nav overlay */}
      {mobileOpen && (
        <div className="md:hidden fixed top-14 left-0 right-0 z-[100] bg-white border-b border-rose-100 shadow-lg max-h-[calc(100vh-3.5rem)] overflow-y-auto">
