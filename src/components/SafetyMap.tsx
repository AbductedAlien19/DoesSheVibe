    ...
    >
      ...
      {pickedLocation && (
        <Marker
          ...
          icon={L.divIcon({
            html: `<div style="width: 28px; height: 28px; position: relative;"><div style="position: absolute; inset: 0; border-radius: 50%; background: rgba(236,72,153,0.25); border: 3px solid #ec4899; box-shadow: 0 0 0 4px rgba(236,72,153,0.15), 0 2px 6px rgba(0,0,0,0.3);"></div><div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%,-50%); width: 8px; height: 8px; border-radius: 50%; background: #ec4899;"></div></div>`,
            className: '',
            iconSize: [28, 28],
            iconAnchor: [14, 14],
          })}
        >
          <Popup>
            <div className="text-sm font-semibold text-rose-600">Pinned location</div>
          </Popup>
        </Marker>
      )}
